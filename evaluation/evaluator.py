...
class LLMJudge:
    ...
    JUDGE_PROMPT = """你是一个项目管理助手质量评估专家。请对以下项目管理助手的响应进行评分。
...
DEFAULT_INTENT_CASES: List[IntentTestCase] = [
    IntentTestCase("帮我规划这个项目",                 "plan"),
    IntentTestCase("把这个需求拆解成任务",             "plan"),
    IntentTestCase("帮我排一下项目工期",               "schedule"),
    IntentTestCase("项目进度怎么样了",                 "track"),
    IntentTestCase("有哪些任务逾期了",                 "track"),
    IntentTestCase("有什么项目风险",                   "risk"),
    IntentTestCase("生成一份周报",                     "report"),
    IntentTestCase("你好",                             "greeting"),
]

DEFAULT_DIALOG_CASES: List[Dict[str, Any]] = [
    {"question": "帮我规划一个电商网站上线项目"},
    {"question": "项目进度怎么样了，有哪些任务还没完成"},
    {"question": "帮我生成这周的周报"},
    {"turns": ["帮我把这个项目拆成任务", "第一个任务安排给谁", "如果第一个任务延期会有什么影响"]},
]
